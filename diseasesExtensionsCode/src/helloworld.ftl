...
<LexicalResource
    ...
    xmlns:meshL="https://github.com/francisjqr/ER-Wordnet-Extension/blob/master/MeSH-extension.xml"
    ...
    <Lexicon id="${lexicon_Id}"
        ...
        <Synset id="${synset.id}">
            ...
            <SynsetRelation target="${synset.sense.target}"
                relType="${synset.sense.relType}" 
                relName="${synset.sense.relName}"/>
            <#--  </#list> -->
        </Synset>
        </#list>
